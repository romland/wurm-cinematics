...
2022 note II: While I could not find the actual site (documentation was largely automatically generated if I recall), I did find the examples and they are now hosted here: https://github.com/romland/wurm-cinematics-docs/tree/main/examples and the repo is at https://github.com/romland/wurm-cinematics-docs
   ...
   This is a client mod for Wurm Unlimited.
                  ...
                  -- Friya  (and often Friyanouce when in Wurm Online,
                             drop by Milliways on Pristine to say hi!)
   ...
   > bind 8 "act 30551 selected"     (this will bind "stop script" to the 
   '8' key).
