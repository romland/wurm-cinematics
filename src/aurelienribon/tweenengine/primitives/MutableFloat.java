...
public class MutableFloat extends Number implements TweenAccessor<MutableFloat> {
	...
	@Override
	public int getValues(Tween tween, MutableFloat target, int tweenType, float[] returnValues) {
		returnValues[0] = target.value;
		return 1;
	}

	@Override
	public void setValues(Tween tween, MutableFloat target, int tweenType, float[] newValues) {
